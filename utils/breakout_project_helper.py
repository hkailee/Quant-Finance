import utils.breakout_helper as helper
import scipy.stats
...
py.tools.set_credentials_file(username='hongkai', api_key='CsdylGCfFZHwaQPiuyvM')
...
#     plot_url = plotly.iplot({'data': traces, 'layout': layout}, filename=title, config=config)
    plot_url = offline_py.iplot({'data': traces, 'layout': layout}, filename=title, config=config)

    print('URL for', title, 'is', plot_url)
...
#         plot_url = plotly.iplot({'data': [stock_trace, signal_return_trace], 'layout': layout}, \
#                                     filename=title, config=config)
        plot_url = offline_py.iplot({'data': [stock_trace, signal_return_trace], 'layout': layout}, \
                                    filename=title, config=config)
        print('URL for', title, 'is', plot_url)
